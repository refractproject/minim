...
module.exports = function(registry) {
  return createClass({
    ...
    fromRefract: function(doc) {
      ...
      if (doc.meta) {
        traverseMeta(doc.meta, this, registry);
      }
...
function traverseMeta(meta, el, registry) {
  // We know meta is an object, so we can skip the checks
  traverseObject(meta, el.meta, registry);
}

function traverseObject(obj, el, registry) {
  Object.keys(obj).forEach(function (key) {
    ...
    if (value.element) {
      ...
      var newArray = registry.toElement([]);
...
function traverseArray(value, el, registry) {
