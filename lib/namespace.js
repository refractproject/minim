...
var Namespace = createClass({
  ...
  useDefault: function() {
    ...
    this
      .detect(isNull, NullElement, false)
      .detect(isString, StringElement, false)
      .detect(isNumber, NumberElement, false)
      .detect(isBoolean, BooleanElement, false)
      .detect(Array.isArray, ArrayElement, false)
      .detect(isObject, ObjectElement, false);
