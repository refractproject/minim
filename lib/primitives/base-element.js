...
var BaseElement = createClass({
  ...
  toValue: function() {
    if (this.content instanceof BaseElement) {
  ...
  content: {
    ...
    set: function(newValue) {
      if (this._content instanceof BaseElement || this._content instanceof KeyValuePair) {
      ...
      if (newValue instanceof BaseElement || newValue instanceof KeyValuePair) {
