...
var ArrayElement = Element.extend({
  ...
  'fantasy-land/map': function(transform, thisArg) {
    return new this.constructor(this.map(transform, thisArg));
  },
    ...
    return this
      .map(function (element) {
        ...
        if (Array.isArray(result)) {
          // Transform returned an array, wrap it in an array element
          return new this.constructor(result);
        } else if (result instanceof this.constructor) {
          // Transform returned an array based element
          return result;
        } else {
          // Transform returned an non-array, wrap it in an array
          return new this.constructor([result]);
        }
      }, this)
