...
module.exports = function(registry) {
  return createClass({
    ...
    convertKeyToRefract: function (ret, key, item) {
      if (this.shouldRefract(item)) {
        ret[key] = item.toRefract();
        return;
      }
    ...
    convertMetaToRefract: function() {
      ...
      this.meta.keys().forEach(function (key) {
        this.convertKeyToRefract(meta, key, this.meta.get(key));
      }, this);
    ...
    convertAttributesToRefract: function() {
      ...
      this.attributes.keys().forEach(function (key) {
        this.convertKeyToRefract(attributes, key, this.attributes.get(key));
      }, this);
