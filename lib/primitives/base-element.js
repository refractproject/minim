...
module.exports = function(registry) {
  return createClass({
    ...
    toValue: function() {
      if (this.content instanceof registry.BaseElement) {
    ...
    toRefract: function() {
      return registry.serialiser.serialise(this);
    },

    fromRefract: function() {
      return registry.serialiser.fromRefract(this);
    },
